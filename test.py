...
# TODO 2：要评估的数据集 — 逗号分隔；留空 = datasets/ 下全部
#   例: DATASETS = "MSRCV1"
#   例: DATASETS = "MSRCV1,Out-Scene"
DATASETS = f"ALOI-100,MSRCV1,Out-Scene,Synthetic3d"             # 字符串：数据集名列表（逗号分隔，留空 = 全部）
...
if __name__ == '__main__':
    ...
    #   例: --datasets MSRCV1                ← 只评一个数据集
    #   例: --datasets MSRCV1,Out-Scene      ← 多个数据集用逗号分隔
    parser.add_argument('--datasets', type=str, default='', help='要评估的数据集名称列表，逗号分隔（默认：全部 .mat）')
